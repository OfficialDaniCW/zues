...
const _ACTION_RECENTS_KEY = 'Zeus-msg-actions-recent';
 ...
 */
const _USER_ACTION_RECENTS_KEY = 'Zeus-user-actions-recent';
...
export function addMessage(role, content, modelName, metadata) {
  try {
    ...
    var _roleText = role === 'user' ? 'You' : (isSlash || isCompacted) ? 'Zeus' : modelRouteLabel(replyModels.requestedModel, resolvedModel);
