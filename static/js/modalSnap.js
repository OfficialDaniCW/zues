...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'Zeus-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'Zeus-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('Zeus:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
