...
function initMermaid() {
  if (!window.mermaid || window.__ZeusMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__ZeusMermaidReady = true;
}
window.ZeusInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'Zeus-thinking-expanded';
